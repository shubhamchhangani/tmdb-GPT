    ...
    return(
        <div className="w-[100vw] h-[110vh]">
            ...
            <form className="w-[80vw] md:w-3/12 absolute p-12 bg-black mt-36 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-80  mb-4">
                ...
                <input type="text" placeholder="Email" className="w-full rounded-md bg-gray-700 p-3 mb-3" />
                <input type="password" placeholder="Password" className="w-full rounded-md bg-gray-700 p-3 mb-3" />
                <button className="py-3 w-full bg-red-700 text-white rounded-md my-4 font-bold text-2xl">{isSignInForm ? "Sign in" : "Sign up"}</button>
